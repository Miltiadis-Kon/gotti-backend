...
SECRET_KEY = 'django-insecure-ob8d5!y$uh0i4_&4ap-l+o3%p&-cxj(d(5j@e2q^^_q-^v@use'
...
INSTALLED_APPS = [
    ...
    'rest_framework', # Add this line to include the rest_framework
    'corsheaders', # Add this line to include the corsheaders
]
